...
(function(c){c.extend(c,{FlashSprite:function(d){var b=this;this.EVENT_READY="flashSpriteReady";this.EVENT_END="flashSpriteEnd";this.EVENT_ENTER_FRAME="flashSpriteEnterFrame";this.options={src:null,fps:30,autoPlay:!0,repeat:!0};this.vars={frames:null,meta:null,image:null,width:null,height:null,length:null,interval:null};this.node=d;this.index=0;this.timer=null;this.init=function(a){a&&this.config(a);a.obj?this.setObj(a.obj):this._load()};this.config=function(a){c.extend(this.options,a);this.vars.interval=
	Math.floor(1E3/this.options.fps)};this._call=function(a,b){c.isFunction(this[a])&&this[a].apply(this,b)};this._load=function(){c.getJSON(this.options.src).done(function(a){var d=new Image;c.extend(b.vars,{meta:a.meta,image:b.options.src.replace(/((\?|#).+|[^\/]+)?$/,"")+a.meta.image,frames:a.frames,length:a.frames.length,width:a.frames[0].sourceSize.w,height:a.frames[0].sourceSize.h});d.onload=c.proxy(b._initNode,b);d.src=b.vars.image})};this.setObj=function(a){var d=new Image,e=b.options.src,e=null!=
	e?e.replace(/((\?|#).+|[^\/]+)?$/,""):"";c.extend(b.vars,{meta:a.meta,image:e+a.meta.image,frames:a.frames,length:a.frames.length,width:a.frames[0].sourceSize.w,height:a.frames[0].sourceSize.h});d.onload=c.proxy(b._initNode,b);d.src=b.vars.image};this._initNode=function(){this.node.width(this.vars.width).height(this.vars.height).css({"background-repeat":"no-repeat","background-image":"url("+this.vars.image+")"});this.options.autoPlay&&this.play();this.node.trigger(this.EVENT_READY)};this.play=function(){this.stop();
	this._forward()};this.next=function(){var a=(this.index+1)%(this.vars.length-1);(this.options.repeat||a)&&this._goto(a)};this._forward=function(){var a=b.index;b.next();a!==b.index?b.timer=setTimeout(b._forward,b.vars.interval):b.node.trigger(b.EVENT_END)};this.reverse=function(){this.stop();this._backward()};this.prev=function(){var a=this.index-1;if(0>a){if(!this.options.repeat)return;a=this.vars.length-1}this._goto(a)};this._backward=function(){var a=b.index;b.prev();a!==b.index?b.timer=setTimeout(b._backward,
